...
<!-- /.container-fluid -->
<form class="dokter" method="post" action="<?= base_url('TugasUser/edit2') ?>">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="link_tugas" name="link_tugas" value="<?php echo $tugas['link_tugas'];  ?>">
